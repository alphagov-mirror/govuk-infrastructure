...
module "static" {
  ...
  environment_variables = merge(
    ...
    {
      ASSET_HOST          = "https://static-ecs.${local.defaults.environment_variables.GOVUK_APP_DOMAIN_EXTERNAL}",
...
module "draft_static" {
  ...
  environment_variables = merge(
    local.static_defaults.environment_variables,
    {
      ASSET_HOST          = "https://draft-static-ecs.${local.defaults.environment_variables.GOVUK_APP_DOMAIN_EXTERNAL}",
